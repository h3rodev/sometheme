                        ...
                        <div class="container">
                            ...
                            <div class="top-right">
								...
								if(!is_user_logged_in()): ?>
									<li><a title="<?php _e('Login', 'iamd_text_domain'); ?>" href="<?php echo wp_login_url(get_permalink()); ?>"><span class="fa fa-sign-in"></span><?php _e('Member Login', 'iamd_text_domain'); ?></a></li>
