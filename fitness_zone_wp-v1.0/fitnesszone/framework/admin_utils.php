...
function dt_theme_default_option() {
	$general = array (
			...
			"top-bar-left-content" => '<i class="fa fa-phone"></i>Any Questions? Call Us: <span>1-223-355-2214</span>',
			...
			"copyright-text" => '&copy; 2015 - Fitness Zone. Design: <a href="http://themeforest.net/user/designthemes" title="">Design Themes</a>',
			"currency-symbol" => "$",
