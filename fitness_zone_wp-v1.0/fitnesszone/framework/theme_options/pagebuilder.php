            ...
            <div class="bpanel-box">
                ...
                <div class="box-content">
                    ...
                    <div class="bpanel-option-set">
                        <h6><?php _e('Choose any of these post types to activate page builder','iamd_text_domain');?></h6>
						<?php
						$custom_post_types = array( 'post' => 'Post', 'page' => 'Page', 'dt_galleries' => 'Gallery', 'dt_workouts' => 'Workouts');
