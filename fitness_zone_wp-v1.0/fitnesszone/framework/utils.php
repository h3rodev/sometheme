...
function dt_theme_event_venue_details($event_ID) {
	...
	$out = '<p>'.$venue_all.'&nbsp; <a href="http://maps.google.com/maps?f=q&source=s_q&hl=en&geocode=&q='.urlencode($venue_all).'"><span class="fa fa-map-marker"></span> '.__('Google Map','iamd_text_domain').'</a></p>';
	return $out;
} ?>