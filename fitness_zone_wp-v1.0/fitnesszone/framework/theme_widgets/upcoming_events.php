...
class MY_Upcoming_Events extends WP_Widget {
	#1.constructor
	function MY_Upcoming_Events() {
		$widget_options = array("classname"=>'widget_upcoming_events', 'description'=>'To list out events');
		$this->WP_Widget(false,IAMD_THEME_NAME.__(' Events','iamd_text_domain'),$widget_options);
	}
		...
		echo "<div class='upcoming-events-widget'><ul>";
			 ...
			 while($the_query->have_posts()):
				...
				echo "<li>";
					...
					$image = ( $image != false)? $image[0] : "http://placehold.it/70x60";
